      ...
      if (!CmndOneLine(NULL, "sysctl hw.model", res))
      {
         if (strstr(res, "PowerMac"))
         {
            if (strstr(res,"c1,2")||strstr(res,"c3,1")||strstr(res,"c3,2")||
                ...
                strstr(res,"c3,6")||strstr(res,"c5,1"))
               mach = PPCG4;
         ...
         {
            if (strstr(res,"c3,2") || strstr(res,"c3,3") || strstr(res,"c3,4")||
                strstr(res,"c3,5") || strstr(res,"c5,1") || strstr(res,"c5,2")||
                strstr(res,"c5,3") || strstr(res,"c5,4") || strstr(res,"c5,5")||
                strstr(res,"c5,6") || strstr(res,"c5,7") || strstr(res,"c5,8")||
                strstr(res,"c5,9") || strstr(res,"c6,1") || strstr(res,"c6,2")||
                strstr(res,"c6,3") || strstr(res,"c6,4") || strstr(res,"c6,5")||
                strstr(res,"c6,7") || strstr(res,"c6,8"))
               mach = PPCG4;
         }
